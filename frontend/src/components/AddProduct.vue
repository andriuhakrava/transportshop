<template>
	<div>
        ...
        <input type="text" id="name" class="form-control" required 
        			v-model.trim="newProduct.name" :class="{ 'is-invalid': $v.newProduct.name.$error }"
      ...
      <div class="form-group">
        ...
        <textarea type="text" id="descriptions" class="form-control" rows="5"
        	v-model.trim="newProduct.descriptions">
        </textarea>
      </div>
      <div class="form-group">
        <label for="images">Images: </label>
        <!-- <input type="file" @change="addImage" :value="images" /> -->
        <input type="text" class="form-control" id="images" v-model="newProduct.selectedImage" />
      </div>
      <div class="form-group">
      	<label>Category (only from existing ones): </label>
        <select id="category" v-model="newProduct.category" class="form-control" 
      ...
      <div class="form-group">
        ...
        <input type="text" id="brand" class="form-control" required 
        			v-model.trim="newProduct.brand" :class="{ 'is-invalid': $v.newProduct.brand.$error }"
      ...
      <div class="form-group">
        ...
        <input type="text" id="model" class="form-control" required 
        			v-model.trim="newProduct.model" :class="{ 'is-invalid': $v.newProduct.model.$error }"
      ...
      <div class="form-group">
        ...
        <input type="text" id="specifications" class="form-control" required 
        			v-model.trim="specifications" /> -->
        <label for="engine">Engine: </label>
        <input type="text" id="engine" class="form-control" required 
                v-model.trim="newProduct.specifications.engine" />      
      </div>
      <div class="form-group">
        <label for="price">Price: </label>
        <input type="text" id="price" class="form-control" required 
        			v-model.trim="newProduct.price" :class="{ 'is-invalid': $v.newProduct.price.$error }"
      ...
      <div class="form-group">
        ...
        <input type="text" id="currency" class="form-control" required 
        			v-model.trim="newProduct.currency" :class="{ 'is-invalid': $v.newProduct.currency.$error }"
	...
	export default {
      ...
      newProduct: {
        ...
        this.newProduct.images.push(this.newProduct.selectedImage);
				console.log('Test Product!', this.newProduct);
        console.log('Type Pricefield', typeof parseInt(this.newProduct.price));
